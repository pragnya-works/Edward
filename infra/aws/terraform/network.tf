...
resource "aws_security_group" "alb" {
  ...
  description = "Ingress for edge ALB"
  vpc_id      = aws_vpc.main.id
  ...
  ingress {
    ...
    to_port     = 80
    protocol    = "tcp"
    cidr_blocks = var.allowed_cidr_ingress_web
  }
...
resource "aws_security_group" "ecs_hosts" {
  ...
  description = "ECS host network access"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "postgres" {
  ...
  description = "RDS ingress from ECS hosts"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "redis" {
  ...
  description = "ElastiCache ingress from ECS hosts"
  vpc_id      = aws_vpc.main.id
