...
export const metadata: Metadata = {
  ...
  description:
    "Read the Terms and Conditions governing your use of Edward, the AI-powered web application builder.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
...
const TERMS_AND_CONDITIONS_CONTENT = (
    <main className="min-h-[100dvh] dark bg-background text-foreground">
      <div className="container max-w-3xl mx-auto px-4 sm:px-6 py-12 md:py-16 lg:py-20">
        <div className="mb-12 md:mb-16 lg:mb-20">
          ...
          <p className="mt-3 text-base md:text-lg text-muted-foreground/80 max-w-lg leading-relaxed">
            The terms governing your use of Edward.
          </p>
        ...
        <div className="prose-container space-y-10 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              Welcome to <strong className="text-foreground">Edward</strong> (&ldquo;Company&rdquo;, &ldquo;we&rdquo;,
              &ldquo;our&rdquo;, &ldquo;us&rdquo;)!
            </p>
            <p>
              These Terms of Service (&ldquo;Terms&rdquo;, &ldquo;Terms of Service&rdquo;) govern your use of our
              website located at{" "}
              <a
              ...
              <strong className="text-foreground">Edward</strong>.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              Any contests, sweepstakes or other promotions (collectively, &ldquo;Promotions&rdquo;) made
              available through Service may be governed by rules that are separate from these Terms
              of Service. If you participate in any Promotions, please review the applicable rules
              as well as our Privacy Policy. If the rules for a Promotion conflict with these Terms
          ...
          <section className="space-y-4">
            ...
            <p>
              Content found on or through this Service are the property of Edward or used with
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              enter into this agreement and abide by all of the terms and conditions of Terms. If
              you are not at least eighteen (18) years old, you are prohibited from both the access
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              occur under your account and/or password, whether your password is with our Service
              or a third-party service. You must notify us immediately upon becoming aware of any
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              functionality are and will remain the exclusive property of Edward and its licensors.
              ...
              prior written consent of Edward.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              , with the subject line: &ldquo;Copyright Infringement&rdquo; and include in your claim a
              detailed description of the alleged Infringement as detailed below, under &ldquo;DMCA Notice
              and Procedure for Copyright Infringement Claims&rdquo;.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              to our Service (&ldquo;Feedback&rdquo;). You acknowledge and agree that: (i) you shall not
              ...
              information from you or any third party; and (iv) Company is not under any obligation
              ...
              derivative works, publish, distribute and commercialize) Feedback in any manner and
              for any purpose.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              or controlled by Edward.
            </p>
            <p>
              Edward has no control over, and assumes no responsibility for the content, privacy
            ...
            <p className="uppercase text-xs leading-relaxed tracking-wide text-muted-foreground/70">
          ...
          <section className="space-y-4">
            ...
            <p className="uppercase text-xs leading-relaxed tracking-wide text-muted-foreground/70">
              THESE SERVICES ARE PROVIDED BY COMPANY ON AN &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo; BASIS.
              COMPANY MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS
              TO THE OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT OR MATERIALS INCLUDED
          ...
          <section className="space-y-4">
            ...
            <p className="uppercase text-xs leading-relaxed tracking-wide text-muted-foreground/70">
              ...
              COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY,
              WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION OF
              CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF OR IN CONNECTION
              WITH THIS AGREEMENT, INCLUDING WITHOUT LIMITATION ANY CLAIM FOR PERSONAL INJURY OR
              PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY VIOLATION BY YOU OF ANY FEDERAL,
              STATE, OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF COMPANY HAS BEEN
              PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY LAW,
              IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT
              PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE
              CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW THE EXCLUSION OR
              LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR LIMITATION
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              provide via Service, in our sole discretion without notice. We will not be liable if
              for any reason all or any part of Service is unavailable at any time or for any
          ...
          <p className="mt-16 pt-8 border-t border-border text-xs text-muted-foreground/40">
            These Terms of Service were created for{" "}
            <a
              href="https://edwardd.app"
              className="underline underline-offset-4 hover:text-muted-foreground/70 transition-colors"
            >
              https://edwardd.app
            </a>{" "}
            on 2026-02-28.
