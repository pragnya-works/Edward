...
export function FileSearchModal() {
    ...
    return (
        ...
        >
            ...
            <CommandList className="max-h-[400px] bg-workspace-bg px-1 py-1.5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                        ...
                        return (
                            <CommandItem
                                ...
                                className={cn(
                                    ...
                                    "hover:bg-workspace-hover/35 hover:text-workspace-foreground hover:ring-1 hover:ring-inset hover:ring-workspace-border/55",
                                    "data-[selected=true]:bg-workspace-accent/11 data-[selected=true]:text-workspace-foreground data-[selected=true]:ring-1 data-[selected=true]:ring-inset data-[selected=true]:ring-workspace-accent/35",
                                    isActive &&
                                        "bg-workspace-accent/7 text-workspace-foreground before:absolute before:left-0 before:top-1.5 before:bottom-1.5 before:w-0.5 before:rounded-r before:bg-workspace-accent data-[selected=true]:bg-workspace-accent/18 data-[selected=true]:ring-workspace-accent/50",
                                )}
                            >
                                <VscodeFileIcon
                                    path={file.path}
