      ...
      <SidebarProvider open={open} setOpen={setOpen} animate={true}>
        ...
        >
          ...
          <div className="flex flex-1 min-h-0 min-w-0">
            <div className="p-1.5 sm:p-2 md:p-10 rounded-tl-xl sm:rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-1.5 sm:gap-2 flex-1 w-full min-h-0 overflow-y-auto overflow-x-hidden">
              {children}
            </div>
          </div>
        </div>
