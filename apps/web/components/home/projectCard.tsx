  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative flex flex-col rounded-xl border border-white/[0.05] bg-white/[0.02] p-3 sm:p-4 lg:p-5 transition-all duration-300 hover:border-white/[0.1] hover:bg-white/[0.05] hover:shadow-2xl hover:shadow-black/50 cursor-pointer aspect-video overflow-hidden"
      >
        ...
        <div className="absolute -bottom-18 -right-20 w-[65%] aspect-[7/5] sm:-bottom-20 sm:-right-24 sm:w-[70%] lg:-bottom-24 lg:-right-36 lg:w-[80%] xl:-bottom-32 xl:-right-44 xl:w-[90%] text-white/[0.15] group-hover:text-white/[0.28] transition-all duration-700 group-hover:-translate-x-2 group-hover:-translate-y-1 pointer-events-none">
          <TechnicalBlueprint />
        </div>

        <div className="relative z-10 flex flex-col h-full">
          <div className="flex items-start justify-between mb-2 sm:mb-3">
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 items-center justify-center rounded-lg bg-white/[0.05] text-foreground group-hover:scale-110 transition-transform duration-300">
