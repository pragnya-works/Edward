...
## Purpose
Handle chat HTTP delivery concerns: auth, validation, response mapping, and SSE wiring.
...
3. Controller delegates orchestration to services/use-cases (including stream runtime in `services/chat/session/*`).
