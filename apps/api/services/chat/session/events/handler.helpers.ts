...
import {
  executeInstallPhase,
} from "../../../../services/planning/workflow/steps/executeInstallPhase.js";
import { ensureSandbox as ensureWorkflowSandbox } from "../../../../services/planning/workflow/steps/ensureSandbox.js";
...
export async function resolveCommandSandboxId(
  ...
  try {
    const provisionedSandboxId = await ensureWorkflowSandbox(
      ctx.workflow,
      ctx.workflow.context.framework,
      ctx.isFollowUp,
    );
