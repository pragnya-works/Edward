...
import { uploadBuildFilesToS3, uploadSpaFallback } from "../../upload.service.js";
import { buildPathPreviewUrl } from "../../../preview.service.js";
    ...
    if (userId && chatId) {
      ...
      if (previewUploaded) {
        if (config.deployment.type === DEPLOYMENT_TYPES.SUBDOMAIN) {
          ...
          const pathPreviewUrl = buildPathPreviewUrl(userId, chatId);
